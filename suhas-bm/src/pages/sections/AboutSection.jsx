  ...
  <section id="about" className="py-24" ref={ref}>
    <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
      ...
      <Motion.div
        ...
        className="relative"
      >
        <div className="absolute inset-0 translate-x-4 translate-y-4 rounded-4xl border border-white/10 bg-white/3" />
          ...
          <div className="relative space-y-6">
            <div className="rounded-3xl border border-white/10 bg-slate-950/55 p-5">
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-white/58">
                Balanced across API design, system reliability, and product delivery.
              </p>
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
            {about.highlights.map((item) => (
              <div key={item.title} className="rounded-[1.25rem] border border-white/10 bg-white/3 p-4">
